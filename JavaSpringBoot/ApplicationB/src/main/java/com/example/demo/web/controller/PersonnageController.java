...
public class PersonnageController {
    ...
    public Personnage getRandomPersonnage() {
        ...
        int rand = getRandomBetween(0, personnages.length);
    ...
    public Personnage createRandomPersonnage() {
        ...
        Personnage personnage = new Personnage(getMaxId(Personnages), getRandomName(), getRandomBetween(5, 10), getRandType());
